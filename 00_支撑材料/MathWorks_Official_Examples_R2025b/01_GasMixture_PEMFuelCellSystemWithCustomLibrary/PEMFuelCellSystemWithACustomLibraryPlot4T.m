...
if ~exist('h4_PEMFuelCellSystemWithACustomLibrary', 'var') || ...
        ~isgraphics(h4_PEMFuelCellSystemWithACustomLibrary, 'figure')
    h4_PEMFuelCellSystemWithACustomLibrary = figure('Name', 'PEMFuelCellSystemWithACustomLibrary');
end
figure(h4_PEMFuelCellSystemWithACustomLibrary)
clf(h4_PEMFuelCellSystemWithACustomLibrary)

plotTemperature(simlog_PEMFuelCellSystemWithACustomLibrary)
...
T_anode = simlog.Anode_Gas_Channels.Anode.T_I.series.values('degC');
T_cathode = simlog.Cathode_Gas_Channels.Cathode.T_I.series.values('degC');
